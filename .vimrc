...
noremap q :! ~/src/axm/bin/company_intro -uid 204 -ms 1 2 3 4 5 6 -tps 11 12 13 14 -iids 1 2 3<CR><CR>
noremap <Leader>l :call RunAllSpecs()<CR>
let g:rspec_command = 'call Send_to_Tmux("rspec {spec}\n")'

noremap <Leader>b :w! .tmp.xyz<CR>:call Send_to_Tmux("ruby .tmp.xyz\n")<CR>

noremap M :call Send_to_Tmux("/Users/wagnerizing/phpunit/vendor/phpunit/phpunit/phpunit.php --colors ".expand("%")."\n")<CR>
...
let g:syntastic_jslint_exec='/usr/maxm/lib/node_modules/jslint'
...
hi DiffText  ctermfg=0 ctermbg=2 cterm=bold
let g:pep8_map="<F6>"

" add ctrlp
set runtimepath^=~/.vim/bundle/ctrlp.vim

command Head !(cd ~/src/axm2/axm/service/platform && make head)
command Front !(cd ~/src/axm2/axm/service/front && make)
